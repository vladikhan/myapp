...
describe "職員による自分のアカウントの管理", "ログイン前" do
  before { host! 'staff.baukis2.example.com' } # <- host для staff
...
describe "職員による自分のアカウントの管理" do
  ...
  before do
    host! 'staff.baukis2.example.com'   # <- host для staff
  ...
  describe "更新" do
    ...
    example "例外ActionController::ParameterMissingが発生" do
      expect { patch staff_account_url, params: {} }.to raise_error(ActionController::ParameterMissing)
    end
